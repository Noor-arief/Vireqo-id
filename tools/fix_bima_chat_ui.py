...
.bima-panel{width:min(410px,calc(100vw - 32px));height:min(560px,calc(100dvh - 120px));max-height:min(560px,calc(100dvh - 120px))}
.bima-panel .bima-body{flex:1 1 auto;min-height:0;overflow-y:auto;overscroll-behavior:contain;padding:14px}
...
@media (max-width:600px){
  .bima-panel{top:auto;left:10px;right:10px;bottom:72px;width:auto;height:min(560px,calc(100dvh - 96px));max-height:min(560px,calc(100dvh - 96px));border-radius:18px}
